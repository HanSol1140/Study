                  ...
                  <div class="customer_inquiry">
                     <form method="post" action="UpdateBoardCtrl.do">
                        ...
                        <table class="table">
                           ...
                           <tr>
                              <td>
                                 <textarea name="content" cols="40" rows="10"class="form-control">${list.content }</textarea>
                              </td>                           
                           </tr>
                           <tr>
                              <td colspan="2" class="btn"><br>
                                 ...
                                 <input type="button" value="전체목록"  onclick='location.href="GetBoardListCtrl"' class="btn_color2">
                              </td>                              
                           </tr>
                        </table>
                     </form>
