        ...
        <section class="top_ban_point cf">
            <div class="top_ban">
                ...
                <div class="p_list cf">
                    <div class="point">
                        <ul class="info-point">
                            <li><span class="p">S.I.포인트</span> <em class="w"><a href="#">0</a>P</em></li>
                ...
                <div class="mypage_search_content">
                    ...
                    <div class="search">
                        ...
                        <div class="search_btn">
                            <input type="radio" id="aa0" name="selPeriod" value="1개월" data-type="month" data-val="1" checked="checked">
                            <label for="aa0">
                                <span>1개월</span>
                            </label>

                            <input type="radio" id="aa1" name="selPeriod" value="3개월" data-type="month" data-val="3">
                            <label for="aa1">
                                <span>3개월</span>
                            </label>

                            <input type="radio" id="aa2" name="selPeriod" value="6개월" data-type="month" data-val="6">
                            <label for="aa2">
                                <span>6개월</span>
                            </label> 
                        </div>         
                    ...
                    <ul class="mypage-shopping__step-wrap">
                        <li class="mypage-shopping__step-item-2">
                            ...
                            <div class="mypage-shopping__step-wrap-2">
                                ...
                                <div>
                                    <p class="mypage-shopping__step-description">주문이 정상적으로 접수되었으니,<br> 입금기한 내에 결제를 완료해 주세요.</p>
                        ...
                        <li class="mypage-shopping__step-item-2">
                            ...
                            <div class="mypage-shopping__step-wrap-2">
                                ...
                                <div>
                                    <p class="mypage-shopping__step-description">주문상품을 확인하고 있습니다.<br> 배송 지연 및 품절이 발생할 수 있습니다.</p>
                                    <ul class="siv-bullet siv-bullet--gray">
                                        <li>배송지 변경 가능</li>
                                        <li>주문취소 가능</li>
                                    </ul>
                        ...
                        <li class="mypage-shopping__step-item-2">
                            ...
                            <div class="mypage-shopping__step-wrap-2">
                                ...
                                <div>
                                    <p class="mypage-shopping__step-description">상품의 배송을 준비하는 중입니다.<br> 배송 지연 및 품절이 발생할 수 있습니다.</p>
                                    <ul class="siv-bullet siv-bullet--gray">
                        ...
                        <li class="mypage-shopping__step-item-2">
                            ...
                            <div class="mypage-shopping__step-wrap-2">
                                ...
                                <div>
                                    <p class="mypage-shopping__step-description">택배사로 상품이 전달되어<br> 배송이 시작되었습니다.</p>
                                    <ul class="siv-bullet siv-bullet--gray">
                                        <li>교환신청 가능</li>
                                        <li>반품신청 가능</li>
                                    </ul>
                        ...
                        <li class="mypage-shopping__step-item-2">
                            ...
                            <div class="mypage-shopping__step-wrap-2">
                                ...
                                <div>
                                    <p class="mypage-shopping__step-description">고객님께서 상품을 안전하게 받으셔서<br> 배송이 완료된 상태입니다.</p>
                                    <ul class="siv-bullet siv-bullet--gray">
                                        <li>교환신청 가능</li>
                                        <li>반품신청 가능</li>
                                    </ul>
